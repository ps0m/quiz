...
const questions: Question[] = [
  ...
  {
    id: 3,
      question: 'Яна зарадзілася на востраве ў школе аднайменнага горада, але заваявала сэрцы мільёнаў на іншым кантыненце і гэтая гульня ператварылася ў рэлігію для пэўнага народа. Гэтую гульню часам называюць "хуліганскай", якую гуляюць джэнтльмены.',
      answer: 'Рэгбі',
      answerLanguage: 'беларуская',
      wordCount: 1,
      theme: 'sport'
    ...
    {
        id: 6,
        question: 'Ііі.. апошняе пытанне, табе дапаможа разгадэць гэты рэбус папярэдні адказ. А вось і тое, што патрэбна разгадаць: "СЖТВОРЕВ"',
        answer: 'Перамога',
        answerLanguage: 'беларуская',
        wordCount: 1,
        theme: 'cipher'
